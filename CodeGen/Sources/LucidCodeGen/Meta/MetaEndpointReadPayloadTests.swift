//
//  MetaEndpointReadPayloadTests.swift
//  LucidCodeGen
//
...
struct MetaEndpointReadPayloadTests {
    ...
    init?(endpointName: String,
        ...
        guard let readTests = endpoint.tests?.readTests else {
            return nil
        }

        self.endpointName = endpointName
        self.tests = readTests
    ...
    func meta() throws -> Type {
        ...
        return Type(identifier: TypeIdentifier(name: "\(endpoint.transformedName)ReadPayloadTests"))
