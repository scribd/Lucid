...
extension Import {
    ...
    static func lucidTestKit(reactiveKit: Bool) -> Import {
        return Import(name: "LucidTestKit\(reactiveKit ? "_ReactiveKit" : "")", testable: false)
    }
...
extension Subtype.Property.PropertyType {
...
extension EndpointPayloadEntity {
